        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-12 mb-12">
          <div className="md:col-span-2">
            ...
            <p className="text-gray-500 text-sm mt-3 max-w-sm leading-relaxed">
              ...
              No polyester. No microplastics. Black that actually stays black.
            </p>
            <p className="text-gray-600 text-xs mt-4 italic">Stay Black. Stay Healthy.</p>
          </div>
          <div>
          ...
          <div>
            ...
            <ul className="space-y-2">
              ...
              <li><a href="mailto:hello@stayblack.com" className="text-gray-500 text-sm hover:text-white transition-colors">Contact</a></li>
            </ul>
          </div>
        </div>
        <div className="border-t border-white/5 pt-8 flex flex-col md:flex-row justify-between items-center gap-4">
          <p className="text-gray-600 text-xs">© 2026 Stay Black. All rights reserved.</p>
